...
export const getTimeSlots = asyncHandler(async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Time slots fetched successfully", timeSlots, count: timeSlots.length });
  } catch (error) {
    console.error(error);
...
export const getTimeSlot = asyncHandler(async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Time slot fetched successfully", timeSlot });
  }
  catch (error) {
    console.error(error);
