...
// const EditTimeSlotsContent = ({ timeSlot, onClose, onTimeSlotUpdated }) => {
...
//         sameDay: timeSlot.sameDay || "Same Day",
...
//     try {
//       const response = await updateTimeSlot(timeSlot._id, formData);
//       if (response) {
...
//           <h2 className="text-2xl font-bold text-white">Edit Time Slot</h2>
//           <button
//             onClick={onClose}
...
// export default EditTimeSlotsContent;
import React from 'react'

const EditTimeSlotsContent = () => {
  return (
    <div>EditTimeSlotsContent</div>
  )
}
