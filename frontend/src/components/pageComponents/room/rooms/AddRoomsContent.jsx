...
const AddRoomsContent = ({ onClose, onSuccess }) => {
  ...
  useEffect(() => {
    const fetchRoomTypes = async () => {
      try {
        ...
        setRoomTypes(response || []); // Ensure we always have an array
      } catch (error) {
    ...
    >
      <div className="max-w-7xl mx-auto p-6">
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    className="react-select-container transform hover:scale-[1.01] transition-all duration-200"
          ...
          {/* Enhanced Features and Amenities Section */}
          <div className="bg-gradient-to-br from-purple-600/10 to-pink-600/10 dark:from-purple-900/30 dark:to-pink-900/30 p-6 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg backdrop-blur-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-200/50 dark:border-gray-700/50 transform hover:scale-[1.02] transition-all duration-200">
          ...
          <div className="sticky bottom-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md p-6 rounded-2xl border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-4">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2.5 text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700/50 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 transform hover:scale-105"
            >
              Cancel
            </button>
            <button
...
export default AddRoomsContent;